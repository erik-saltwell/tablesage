...
New tracked work uses `WORK-ITEMS.md` and `.work-items/`; existing `.scratch/` designs are supporting references. See `docs/agents/issue-tracker.md`.

### Triage labels

Current work uses the canonical work-item statuses; older triage labels are historical. See `docs/agents/triage-labels.md`.

### Domain docs

Artifact contracts live in `specs/`; implementation guides live in `.documentation/`. See `docs/agents/domain.md`.
...
[system_architecture.md](.documentation/system_architecture.md)'s "Tools operate on generic inputs... They do not know about...

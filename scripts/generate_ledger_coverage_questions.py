"""Generate candidate coverage questions from Ledger transcript inputs for review."""
...
OUTPUT_DIRECTORY = REPO_ROOT / "prompt_optimization" / "ledger" / "coverage_questions"
UTILITY_PROMPT_PATH = REPO_ROOT / "utility_prompts" / "generate_questions.md"
INPUT_FILENAMES = ("Brandonsford_002.txt", "Brandonsford_003.txt")
...
async def main() -> None:
    ...
    for input_filename in INPUT_FILENAMES:
        ...
        response: PromptQuestions = await acomplete(
            ...
            log_name="generate_ledger_coverage_questions",
        )

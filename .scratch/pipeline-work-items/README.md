...
Three of the remaining five are still `needs-info`: 03 needs trigger/UI/scope decisions, and 05/06
need the user to name the actual remaining gap rather than the terse one-liner they were raised
with.

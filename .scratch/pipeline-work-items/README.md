...
[03-design.md](03-design.md)). Of the three remaining items, 05/06 are still `needs-info`: the user
needs to name the actual remaining gap rather than the terse one-liner they were raised with.

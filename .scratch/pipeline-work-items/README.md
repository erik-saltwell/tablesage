...
| 06 | [Finish Summary generation](06-finish-summary-generation.md) | `ready-for-human` — code done 2026-09-02, pending system prompt + commit |
...
instead of the role transcript) and implemented the same day. 05 is still `needs-info`: the user
needs to name the actual remaining gap rather than the terse one-liner it was raised with.

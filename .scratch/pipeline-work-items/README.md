...
| # | Item | Triage state |
| --- | --- | --- |
| 01 | [Re-add pre-review backchannel removal, batched](01-pre-review-backchannel-removal-batched.md) | `ready-for-agent` — design: [01-design.md](01-design.md) |
...
01 is now `ready-for-agent` after a design brainstorm (2026-08-31) — see
[01-design.md](01-design.md). Three of the remaining five are still `needs-info`: 03 needs
trigger/UI/scope decisions, and 05/06 need the user to name the actual remaining gap rather than
the terse one-liner they were raised with.

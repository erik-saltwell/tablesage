...
This is optional design guidance, not a specification of implemented behavior or a mandatory shipping checklist. The [screen inventory](../tablesage_tui_screens.md) and [screen code](../../apps/tablesage-tui/src/tablesage_tui/screens) define TableSage's current UI.

...
- [System architecture](../../system_architecture.md): package responsibilities, current startup loading, and settings injection into `Application`.
- [TUI screen conventions](../../tablesage_tui_screens.md): existing landing navigation and interaction conventions. The draft-and-Save Settings editor is a distinct behavior alongside existing inline metadata editors.

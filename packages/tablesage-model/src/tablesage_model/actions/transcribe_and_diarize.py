...
from ..model import SessionSet, SessionUtterance, SessionWord
...
async def transcribe_and_diarize(
    ...
    input_audio_path = paths.to_absolute(session_dir, app_settings.cleaned_audio_file)
    ...
    return SessionSet(utterances=tuple(utterances))

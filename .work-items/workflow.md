...
- `.archive/` is a local, Git-ignored archive of superseded internal reference material. It is optional and must not be required by tracked work. Canonical artifact specifications are retained in their completed contract work items; developer/corpus READMEs stay beside their tools and data.
